...
* (AAAI16) In Fact, Tiebreaking is Quite Important 
...
* (AAAI16) Zero-cost actions makes /h/-Tiebreaking difficult
...
* (AAAI16) Understanding the Final Plateau
...
* (AAAI16) But when almost all edges are 0-cost...
...
* (AAAI16) Depth-based Tiebreaking
...
* (AAAI16) Non-trivial Question: How to use the /Depth?/
...
* (AAAI16) Random Depth Tiebreaking
...
#+begin_larger
+ Optimal solutions as long as *the first criterion* $f\;$ is admissible
#+end_larger
...
|---+-------------------------------------------------------------------------------------------------+---------+---------|
|   | IPC+Zerocost results included                                                                   |   LMcut |     M&S |
|---+-------------------------------------------------------------------------------------------------+---------+---------|
