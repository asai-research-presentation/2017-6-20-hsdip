...
complete satisficing search
incomplete satisficing search
...
* FIFO: selecting the smallest depth?                       :noexport:AAAI16:
...
* LIFO: selecting the largest depth?                        :noexport:AAAI16:
...
* Random Depth Tiebreaking                                  :noexport:AAAI16:
...
* (New materials from here) Connection to Type-based GBFS   :noexport:AAAI16:
...
* Industrial Impact of Zero-Cost
...
* Simple Dynamic Configuration for Overall Performance               :時間使い過ぎ:
...
* depth 削って tiebreaking ごとの completeness
